...
export const CHAMPIONSHIPS = {
  ...
  "coupe-de-france": { slug: "coupe-de-france", name: "Coupe de France", subtitle: "La grande coupe du football français", shortName: "CDF", level: "Coupe nationale", provider: "APIfootball", type: "cup" }
};
...
export async function getChampionshipSnapshot(slug) {
  ...
  if (config.type === "cup") {
    ...
    const now = Math.floor(Date.now() / 1000);
    const matches = [...cup.data].sort((a,b) => a.timestamp-b.timestamp);
