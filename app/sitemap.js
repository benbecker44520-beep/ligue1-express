...
export default async function sitemap() {
  ...
  const now = new Date();
  const staticPaths = ["", "/actualites", "/championnats", "/championnats/ligue-1", "/championnats/ligue-2", "/championnats/national", "/resultats", "/classement", "/stats", "/prono", "/mercato", "/analyses"];
