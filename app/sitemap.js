...
export default async function sitemap() {
  ...
  const now = new Date();
  const staticPaths = ["", "/actualites", "/fil-express", "/live", "/championnats", "/championnats/ligue-1", "/championnats/ligue-2", "/championnats/ligue-3", "/resultats", "/classement", "/stats", "/prono", "/mercato", "/analyses", "/mon-club", "/mes-alertes"];
