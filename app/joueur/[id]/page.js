...
export default async function PlayerPage({ params, searchParams }) {
  ...
  return <div className="page-shell listing-page player-detail-page player-detail-v7">
    ...
    <div className="player-note">Les données sportives proviennent de football-data.org. Les portraits sont enrichis via TheSportsDB lorsqu’ils sont disponibles. Les contenus associés proviennent de Foot Français Express.</div>
  </div>;
}
