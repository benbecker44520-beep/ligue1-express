...
export default async function SupporterRankingPage() {
  ...
  return <main className="page-shell supporter-ranking-page">
    <section className="ranking-hero"><div><span>🏆 V8.13 · LA COMMUNAUTÉ</span><h1>Classement des pronostiqueurs</h1><p>Chaque bon résultat rapporte <strong>3 points</strong>. Enchaîne les bons pronostics et grimpe au classement !</p></div><Link href="/prono">Faire mes pronostics →</Link></section>
