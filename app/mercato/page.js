...
export const metadata = { title: "Mercato", description: "Le centre mercato Foot Français Express : transferts officiels, dossiers avancés, rumeurs et actualités." };
...
function publicationDate(transfer) {
 const value = transfer.occurred_at || transfer.created_at;
 if (!value) return "";
...
export default async function Page({ searchParams }) {
 ...
 return <div className="page-shell listing-page mercato-v6 mercato-v7"><span className="eyebrow">FOOT FRANÇAIS EXPRESS · TRANSFERTS</span><h1>Centre Mercato</h1><p className="mercato-lead">Les mouvements qui comptent, séparés des rumeurs. Les clubs et joueurs connus de Foot Français Express sont maintenant directement accessibles.</p>
